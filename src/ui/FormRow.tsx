...
function FormRow({ children, label, error, className }: FormRowProps) {
    ...
    return (
        <div
            className={`border-mako-grey-100 flex flex-col justify-center gap-5 border-b py-4 has-[button]:flex has-[button]:flex-row has-[button]:justify-end has-[button]:gap-4 has-[button]:border-none phone:grid phone:grid-cols-[24rem_1fr_1.5fr] phone:items-center phone:gap-6 tab-port:grid-cols-[24rem_1fr_1fr] tab-port:gap-8 tab-land:grid-cols-[24rem_1fr_0.75fr] tab-land:gap-10 particular-small-laptop:grid-cols-[24rem_1fr_0.5fr] ${className}`}
            style={{}}
        >
                ...
                if (
                    ...
                    return (
                        <>
                            {label && (
                                <label
                                    className="text-mako-grey-700 text-[1.4rem] tracking-wide"
